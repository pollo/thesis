...
\item A set of analysis tools for understanding, study and to map the risk of accidents and its relation with environmental and social factors.
\end{itemize}
This thesis work aims to provide an analysis tool to describe the behavior of skiers while performing their descents on ski slopes. The output of this analysis will be used as a useful component of the analysis module of SicurSkiWeb platform.
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{images/data_tognola.eps}
